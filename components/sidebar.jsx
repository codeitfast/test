...
export default function Sidebar(props) {
  ...
  return (
    <div className={"absolute right-0 bottom-0 mx-4 my-4 transition-all ease-out outline outline-1 rounded-lg w-fit max-w-sm overflow-hidden h-fit max-h-[432] " + (open ? '' : '!w-16')}>
